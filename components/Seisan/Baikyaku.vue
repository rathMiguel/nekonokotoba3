...
<template>
  <section>
    ...
    <div class="flex items-center mb-2" v-for="(value, index) in seisanStatus.amounts" ref="amountRefs">
      <input type="number" class="w-60 border-2 rounded-lg p-2 border-primary" v-on:keydown.enter="handleRowButton(index).increment" v-model="seisanStatus.amounts[index]">
