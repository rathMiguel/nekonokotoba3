...
<template>
  <section>
    ...
    <div class="flex items-center mb-3" v-for="(value, index) in seisanStatus.amounts" ref="amountRefs">
      ...
      <button title="入力枠を減らす" class="rounded-md size-11 text-xl" v-if="(seisanStatus.amounts.length - 1) > 0"
        v-on:click="handleRowButton(index, 'dec')">
